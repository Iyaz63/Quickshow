...
const AddShows = () => {
  ...
  return nowPlayingMovies.length > 0 ? (
    <>
        ...
        <div className='group flex flex-wrap gap-4 mt-4 w-max'>
          {nowPlayingMovies.map((movie) =>(
            <div key={movie.id} className={`relative max-w-40 cursor-pointer
              ...
              duration-300`} onClick={() => setSelectedMovie(movie._id)}>
      ...
      {/* {Show Price Input} */}
      <div className='mt-8'>
        <label className='block text-sm font-medium md-2'>Show Price</label>
      ...
      {/* {Date& Time Selection} */}
      <div className='mt-6'>
        <label className='block text-sm font-medium md-2'>Select Date and Time</label>
